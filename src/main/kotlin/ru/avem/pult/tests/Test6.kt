...
//Испытание повышенным напряжением изолирующей части указателя >1000 В
class Test6(model: MainViewModel, view: TestView, controller: TestController) : Test(model, view, controller) {
