...
class CRC16 private constructor() : Checksum {
    private var sum = 0xFFFF
    private val buffer = ByteBuffer.allocate(2)
    ...
    companion object {
        ...
        fun check(dst: ByteArray, length: Int): Boolean {
            val instance = CRC16()
            instance.update(dst, 0, length - 2)
            val correctSum = instance.value.toShort()
            instance.buffer.clear()
            instance.buffer.put(dst[length - 1])
                .put(dst[length - 2])
                .flip()
            val supposedSum = instance.buffer.short
